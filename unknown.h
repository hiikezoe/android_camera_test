...
typedef enum {
  ...
  CAMERA_PARM_HJR, /*25*/
  CAMERA_PARM_ISO,
  CAMERA_PARM_JPEG_ROTATION, /* SCENE_DETECT?? */
  CAMERA_PARM_SCENE_DETECTION,
  ...
  CAMERA_PARM_FACE_DETECTION, /* orig CAMERA_PARM_CAMERA_INFO, */
  CAMERA_PARM_MODE, /*35*/
  CAMERA_PARM_QUERY_FALSH4SNAP,
  CAMERA_PARM_CAMERA_ID, /*37*/
  CAMERA_PARM_BUFFER_INFO,
  CAMERA_PARM_PREVIEW_SIZE, /*39*/ /* orig CAMERA_PARM_JPEG_ROTATION,*/
  CAMERA_PARM_HORIZONTAL_VIEW_ANGLE, /*40*/
  CAMERA_PARM_VERTICAL_VIEW_ANGLE,
  CAMERA_PARM_ZSL_ENABLE,
  CAMERA_PARM_FOCAL_LENGTH,
  CAMERA_PARM_JPEG_MAINIMG_QUALITY,
  CAMERA_PARM_JPEG_THUMB_QUALITY, /*45*/
  ...
  CAMERA_PARM_WAVELET_DENOISE, /*55*/
